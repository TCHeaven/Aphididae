...
![[Pasted image 20230502173326.png]]
Used to select the minimum number of samples to fully represent the diversity of the dataset.
...
Contains neighbourhood joining phylogeny tree work and MDS work
...
![[Pasted image 20230502175123.png]]
Why?
```bash
